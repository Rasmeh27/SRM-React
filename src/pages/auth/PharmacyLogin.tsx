        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-sm text-gray-500">
              Ingrese con su cuenta para validar y dispensar recetas.
            </p>
          </div>
